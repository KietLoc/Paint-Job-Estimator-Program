...
void displayEstimate(int totalRooms, int totalGallons, double totalLaborHours, double paintCost, double laborCost);
...
int getRooms() 
{
    ...
    do 
    {
        ...
        cin >> rooms;
        if (rooms < 1)
            cout << "  Error: must enter at least 1 room." << endl;
    } 
    while (rooms < 1);
    return rooms;
}
...
double getSqFt(int roomNumber) 
{
    ...
    do 
    {
        cout << "Enter square feet for room " << roomNumber << " (>= 0 sqrt feet): ";
        cin >> sqft;
        if (sqft < 0)
            cout << "  Error: square feet cannot be negative." << endl;
    } 
    while (sqft < 0);
    return sqft;
}
...
double getPricePerGallon() 
{
    ...
    do 
    {
        ...
        cin >> price;
        if (price < 10.0)
            cout << "  Error: price must be at least $10.00." << endl;
    } 
    while (price < 10.0);
    return price;
}
...
void displayEstimate(int totalRooms, int totalGallons, double totalLaborHours, double paintCost, double laborCost)
{
    cout << "\nEstimate for Painting " << totalRooms << " room" << (totalRooms > 1 ? "s" : "") << ":\n";
    cout << "Gallons of paint to purchase: " << totalGallons << endl;
    cout << "Number of hours required to paint: " << totalLaborHours << endl;
    cout << "Cost of Paint: $" << paintCost << endl;
    cout << "Cost of Labor: $" << laborCost << endl;
    cout << "Total cost for job: $" << (paintCost + laborCost) << endl;
}
